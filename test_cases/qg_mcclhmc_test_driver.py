...
obs_checkpoints = np.arange(0, 5000.5001, 50)
...
hmc_filter_configs = dict(model=model,
                          ...
                          gmm_prior_settings=dict(clustering_model='gmm',
                                                  ...
                                                  min_number_of_points_per_component=5,
                          ...
                          analysis_inflation_factor=1.25,
                          hybrid_background_coeff=0.75  # this is multiplied by the modeled background error covariance matrix
                          )
