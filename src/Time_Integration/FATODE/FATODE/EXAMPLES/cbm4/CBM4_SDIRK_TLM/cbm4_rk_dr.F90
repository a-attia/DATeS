...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 !~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  open(unit=2010,file='cbm4_matlab_sol.txt',form='formatted')
  do i=1,nvar
 ...
 !      open(unit=11,file='cbm42d_rk_sol.txt',status='replace')
 !      do i=1,nvar
 !        write(11,2011) var(i)
 ! 2011   format(e24.16)
 !      end do
 !      close(11)
  ...
  program cbm4_rk_dr
    ...
    tend   = tstart + 24.d0 * 3600.d0 * 0.5d0
    temp   = 298.d0
    ...
    !      rcntrl(3)=1d-3
    call cpu_time(t1)
    call integrate(tin=tstart, tout=tend, nvar=nvar, nnzero = nnz,var=var,&
