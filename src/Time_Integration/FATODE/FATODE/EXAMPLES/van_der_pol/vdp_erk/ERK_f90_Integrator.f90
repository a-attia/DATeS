...
CONTAINS
SUBROUTINE INTEGRATE( TIN, TOUT, NVAR, NNZ, VAR, RTOL, ATOL, FUN, &
  ICNTRL_U, RCNTRL_U, ISTATUS_U, RSTATUS_U, Ierr_U )

   IMPLICIT NONE
!~~~>  Statistics on the work performed by the ERK method
   INTEGER, INTENT(IN) :: NVAR, NNZ
  ...
  ! If optional parameters are given, and if they are >0, 
   ...
   T1 = TIN; T2 = TOUT
   CALL ERK( NVAR,NNZ,T1,T2,VAR,RTOL,ATOL,FUN,  &
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   SUBROUTINE ERK(NVAR, NNZ, Tinitial, Tfinal, Y, RelTol, AbsTol, FUN, &
                       RCNTRL, ICNTRL, RSTATUS, ISTATUS, Ierr)
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      IMPLICIT NONE 
      INTEGER, INTENT(IN)          :: NVAR, NNZ,ICNTRL(20)
