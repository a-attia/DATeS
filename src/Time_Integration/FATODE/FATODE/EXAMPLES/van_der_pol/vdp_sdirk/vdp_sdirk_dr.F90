...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!	DRIVER FILE: Van Der Pol SDIRK
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~     
	PROGRAM vdp_sdirk_dr
	...
	CALL INTEGRATE( TIN=T, TOUT=TEND, N=NVAR, NNZERO=NNZ, &
           VAR=VAR, RTOL=RTOL, ATOL=ATOL, FUN=FUN, &
           JAC=JAC, ICNTRL_U=ICNTRL, RCNTRL_U=RCNTRL, ISTATUS_U=ISTATUS, &
           RSTATUS_U=RSTATUS )
