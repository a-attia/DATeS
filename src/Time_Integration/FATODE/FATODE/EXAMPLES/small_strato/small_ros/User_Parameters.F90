...
CONTAINS
   ...
   ! FCT - Time derivative of variable species concentrations
    DOUBLE PRECISION, INTENT(IN) :: T, V(NVAR)
    DOUBLE PRECISION, INTENT(INOUT) :: FCT(NVAR)
 
    DOUBLE PRECISION :: A(NREACT), SUN
  ...
  ! Aggregate function
    ...
    INTEGER, INTENT(IN) :: NVAR
! V - Concentrations of variable species (local)
    DOUBLE PRECISION, INTENT(IN) :: V(NVAR), T
    DOUBLE PRECISION, INTENT(INOUT) :: JF(NVAR,NVAR) 
