...
!~~~> Optional input parameters and statistics
   ...
   ICNTRL(12) = 1      ! 2 - fwd trunc error only, 1 - tlm trunc error
...
!		ICNTRL(12) = 2: TLM error is not used
...
!~~~> TLM truncation error control selection  
      ...
      ELSE
         IF (ICNTRL(12) == 1) THEN 
            TLMtruncErr = .TRUE.
         ELSE 
            PRINT * ,'User-selected TLM truncation error: ICNTRL(12)=',ICNTRL(12)
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~   
   ...
   SELECT CASE (Code)
    ...
    CASE (-10)    
      PRINT * , '--> Options available: Use TLM truncation error [1] or not [2] '
    CASE DEFAULT
