...
class ObservationVector_PETSCSeq(ObservationVectorBase):
    """
    initial PETSC implementation of observation vector operations.
    ...
    Args:
        model_obs_vector_ref: a reference (pointer) to the model's observation vector Yobject.
    ...
    def __init__(self, model_obs_vector_ref, time=None):
        ...
        #
        self._raw_vector = PETSc.Vec().createWithArray(model_obs_vector_ref)
    ...
    def set_local(obs, time=None):
        """
        Set the entries of this observation vector object to the entries of observation.
        ...
        if np.isscalar(obs):
            for i in xrange(self.__size):
                self._raw_vector[i] = obs
            
        else:
            if obs.size != self.__size:
    ...
    def get_raw_vector_ref(self):
        ...
        Returns:
            a reference to the model's vector object (ObservationVector_PETSCSeq._raw_vector).
    ...
    def scale(self, alpha, in_place=True):
        """
        BLAS-like method; scale the underlying ObservationVector_PETSCSeq by the constant (scalar) alpha.
        ...
        Returns:
            The ObservationVector_PETSCSeq object scaled by the constant (scalar) alpha.
    ...
    def dot(self, other, in_place=True):
        ...
        Args:
            other: another ObservationVector_PETSCSeq object.
    ...
    def norm2(self):
        """
        Return the 2-norm of the ObservationVector_PETSCSeq (self).
    ...
    def reciprocal(self, in_place=True):
        ...
        Returns:
            the reciprocal (of all entries) of the ObservationVector_PETSCSeq (self)
    ...
    def square(self, in_place=True):
        ...
        Returns:
            the square (of all entries) of the ObservationVector_PETSCSeq (self)
    ...
    def sqrt(self, in_place=True):
        ...
        Returns:
            the square root (of all entries) of the ObservationVector_PETSCSeq (self)
    ...
    def abs(self, in_place=True):
        ...
        Returns:
            the absolute value (of all entries) of the ObservationVector_PETSCSeq (self)
