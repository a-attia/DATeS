...
class ObservationMatrixSpSciPy(ObservationMatrixBase):
    """
    Sparse SciPy-based implementation of ObservationMatrix operations.
    ...
    Args:
        model_obs_matrix_ref: a reference to the model's SPARSE matrix object to be wrapped.
    ...
    def __init__(self, model_obs_matrix_ref):
        ...
        assert sparse.issparse(model_obs_matrix_ref)
        if model_obs_matrix_ref.ndim != 2:
            raise AssertionError("model_obs_matrix_ref passed is not a two-dimensional.")
        #
    ...
    def set_raw_matrix_ref(self, model_obs_matrix_ref):
        ...
        Args:
            model_obs_matrix_ref: a reference (pointer) to the model's sparse observation matrix object.
    ...
    def get_raw_matrix_ref(self):
        ...
        Returns:
            x: a reference to the model's sparse matrix wrapped by this class.
    ...
    def get_numpy_array(self):
        """
        Returns the sparse observation matrix (a copy) as a 2D NxN dense Numpy array.
        
        Returns:
            a Numpy representation (2D NxN Numpy array) of the nuderlying sparse observation matrix data structure.
    ...
    def copy(self):
        """
        Return a (deep) copy of this object (ObservationMatrixSpSciPy).
    ...
    def scale(self, alpha, in_place=True):
        """
        Scale the underlying ObservationMatrixSpSciPy by the constant (scalar) alpha.
        ...
        Returns:
            The ObservationMatrixSpSciPy object scaled by the constant (scalar) alpha.
    ...
    def vector_product(self, vector, in_place=True):
        ...
        Args:
            ...
            in_place: If True, matrix-vector product is applied (in-place) to the passed ObservationVectorNumpy
                If False, a new copy will be returned.
    ...
    def transpose_vector_product(self, vector, in_place=True):
        ...
        Args:
            vector: ObservationVectorNumpy object
    ...
    def matrix_product(self, other, in_place=True):
        ...
        Args:
            other: another ObservationMatrix object that can be of the same type as this object, 
                or a ObservationMatrixNumpy, or even a regular Numpy array.
    ...
    def matrix_product_matrix_transpose(self, other, in_place=True):
        ...
        Returns:
            The product of self by the transpose of the passed ObservationMatrix (other).
    ...
    def add(self, other, in_place=True, write_to_self=False):
        """
        Add a matrix. The sum of self._raw_matrix with the passed ObservationMatrix (other).
        ...
        if write_to_self:
            ...
            if not in_place:
                ...
                result_mat = self
            if isinstance(other, (ObservationMatrixNumpy, self.__class__)):
                source_matrix = other
                ...
                raise TypeError("matrix has to be either 'ObservationMatrixNumpy', or 'ObservationMatrixSpSciPy', or 'np.ndarray' ")
        else:
        ...
        if isinstance(result_mat, self.__class__):
        ...
        elif isinstance(result_mat, ObservationMatrixNumpy):
            result_mat_ref = result_mat.get_raw_matrix_ref()
            ...
            elif isinstance(source_matrix, (np.ndarray, ObservationMatrixNumpy)):
                result_mat_ref = result_mat_ref + source_matrix_ref
            ...
            print(other)
            raise TypeError("matrix has to be either 'ObservationMatrixNumpy', or 'ObservationMatrixSpSciPy', or 'np.ndarray' ")
            # raise TypeError("matrix has to be either 'ObservationMatrixNumpy', or 'ObservationMatrixSpSciPy'! ")
        #
        return result_mat
        #
    ...
    def solve(self, b):
        ...
        """
        return ObservationVectorNumpy(splinalg.spsolve(self._raw_matrix, b._raw_vector))
        #
    ...
    def diagonal(self, k=0):
        ...
        Args:
            k : int, optional diagonal in question. The default is 0. Use k>0 for diagonals above 
    ...
    def schur_product(self, other, in_place=True):
        """
        Perform elementwise (Hadamard) multiplication with another ObservationMatrix.
        
        Args:
            other: another ObservationMatrix object that can be of the same type as this object, or a ObservationMatrixNumpy,
    ...
    def format(self):
        """
        Get the format of the wraped sparse ObservationMatrix.
    ...
    def str_type(self, value):
        """
        Set the format of the wraped sparse ObservationMatrix.
