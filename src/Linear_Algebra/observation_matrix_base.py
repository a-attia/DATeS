...
class ObservationMatrixBase(object):
    """
    ...
    This should be very similar to state_matrix_base.StateMatrixBase
    Abstract class defining DATeS interface to model matrices (such as observation error covariance matrix).
    ...
    def __init__(self, model_obs_matrix_ref):
        ...
        # Update properties of the ObservationMatrix object.
    ...
    def get_numpy_array(self):
        ...
        Returns:
            a Numpy representation (2D NxN Numpy array) of the nuderlying data observation matrix structure.
