...
class StateVectorNumpy(StateVectorBase):
    """
    Numpy implementation of state vector operations.
    ...
    def __init__(self, model_vector_ref, time=None):
        ...
        assert isinstance(model_vector_ref, np.ndarray)
        if model_vector_ref.ndim != 1:
    ...
    def get_raw_vector_ref(self):
        ...
        Returns:
            a reference to the model's vector object (StateVectorNumpy._raw_vector).
    ...
    def scale(self, alpha, in_place=True):
        """
        BLAS-like method; scale the underlying StateVectorNumpy by the constant (scalar) alpha.
        ...
        Returns:
            The StateVectorNumpy object scaled by the constant (scalar) alpha.
    ...
    def dot(self, other, in_place=True):
        ...
        Args:
            other: another StateVectorNumpy object.
    ...
    def norm2(self):
        """
        Return the 2-norm of the StateVectorNumpy (self).
    ...
    def reciprocal(self, in_place=True):
        ...
        Returns:
            the reciprocal (of all entries) of the StateVectorNumpy (self)
    ...
    def square(self, in_place=True):
        ...
        Returns:
            the square (of all entries) of the StateVectorNumpy (self)
    ...
    def sqrt(self, in_place=True):
        ...
        Returns:
            the square root (of all entries) of the StateVectorNumpy (self)
    ...
    def abs(self, in_place=True):
        ...
        Returns:
            the absolute value (of all entries) of the StateVectorNumpy (self)
